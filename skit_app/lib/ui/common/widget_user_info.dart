    ...
    return Stack(
      children: [
        ...
        Positioned(
            ...
            top: topBorder,
            child: Text("XXXname",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: f20))),
        Positioned(
            left: 70,
            top: topBorder + 40,
            child: Row(
              ...
              children: [
                Text("200",
                    style:
                        TextStyle(fontWeight: FontWeight.w100, fontSize: f12)),
                SizedBox(width: b4),
                Text("Follow",
                    style:
                        TextStyle(fontWeight: FontWeight.w500, fontSize: f12)),
                SizedBox(width: b8),
                Text("1932",
                    style:
                        TextStyle(fontWeight: FontWeight.w100, fontSize: f12)),
